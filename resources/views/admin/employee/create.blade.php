...
<meta name="csrf-token" content="{{ csrf_token() }}"/>
    <div class="row">
        <div class="col-md-12">
            <div class="overview">
                <div class="alert alert-success h4"> You can add new employee from here</div>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-md-8">
            <div class="box box-default box-solid">
                <div class="box-header with-border">
                    <h3 class="box-title">Add System Employee</h3>
                    <!-- /.box-tools -->
                </div>
        ...
        <script>
            ...
            var url = "{{URL::to('/admin/save-employee')}}";
            ...
            function save_user_info() {
                ...
                if ($("#email").val() == "") {
                    alert("Please Provide the Email of the Employee");
                    return;
                }
                ...
                if ($("#password").val() == "") {
                    ...
                    alert("Please Provide the Password of the Employee");
                    return;
                }

                if ($("#branchdropdown").val() == "") {

                    alert("Please Provide the Branch of the Employee");
                    return;
                }
