...
<h2 class="text-blue">
    <i class="fa fa-money text-green" aria-hidden="true"></i> Quotation Report
...
<div class="row well">
    <form class="form-horizontal" role="form" method="POST" action="{{ route('quotationReport.search')}}">
        {{ csrf_field() }}
        <div class="col-md-2">
