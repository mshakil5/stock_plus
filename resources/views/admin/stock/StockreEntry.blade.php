            ...
            <div class="col-md-3">
                ...
                <div class="box box-widget widget-user-2">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <button class="btn btn-success btn-md center-block" id="purchaseBtn" type="submit"><i class="fa fa-plus-circle"></i> Submit </button>
                            </div>
                        </div>
        ...
        var purchaseurl = "{{URL::to('/admin/add-stock')}}";
            ...
            $("body").delegate("#purchaseBtn","click",function(event){
                ...
                $.ajax({
                    url: purchaseurl,
                    method: "POST",
                    data: {date,invoiceno,vendor_id,ref,purchase_type,branch_id,vat_reg,remarks,total_amount,discount,total_vat_amount,net_amount,paid_amount,due_amount,product_id,vat_percent,quantity,unit_price},
