                ...
                <div class="box-body">
                    ...
                    <div class="form-group row">
                        <div class="col-sm-12">
                            ...
                            <button class="btn btn-success btn-md center-block btn-submit" id="quotationBtn" type="submit" style="margin-top: 10px;"><i class="fa fa-plus-circle"></i> Make Quotation </button>
                            <button class="btn btn-success btn-md center-block btn-submit" id="deliveryBtn" type="submit" style="margin-top: 10px;"><i class="fa fa-plus-circle"></i> Make Delivery Note </button>
                            <button class="btn btn-success btn-md center-block btn-submit" id="salesBtn" type="submit" style="margin-top: 10px;"><i class="fa fa-plus-circle"></i> Make Sales </button>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="form-group col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" id="member_id" name="member_id" placeholder="Unique member ID" style="width: 100%;" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="email" name="email" class="form-control" id="email" placeholder="ex. test@gmail.com" style="width: 100%;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="phone" class="form-control" id="phone" placeholder="ex. 0123456789" style="width: 100%;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="vat_number" class="form-control" id="vat_number" placeholder="ex. 0123456789" style="width: 100%;">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <textarea class="form-control" id="address" rows="3" placeholder="1355 Market Street, Suite 900 San Francisco, CA 94103 P: (123) 456-7890" name="address" style="width: 100%;"></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            <div class="row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" name="vehicleno" class="form-control" id="vehicleno" placeholder="ex. 012586" required style="width: 100%;">
                                </div>
                            </div>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $("body").delegate(".unit-price, .quantity", "keyup change", function(event) {
            ...
            $('#grand_total').val(grand_total.toFixed(2));
            $('#net_amount').val((grand_total + total_vat).toFixed(2));

            // Update due amount if necessary
            var paid_amount = parseFloat($("#paid_amount").val()) || 0;
            $('#due_amount').val((grand_total + total_vat - paid_amount).toFixed(2));
        });
